...
def upgrade():
    ...
    sa.Column('email', sa.String(length=256), nullable=False, index=True, unique=True),
    ...
    # this here needs a UNIQUE constraint in artifact_groups, and perhaps same for email
